...
-- Dumping data for table skivor_ab.albums: ~3 rows (approximately)
DELETE FROM `albums`;
INSERT INTO `albums` (`id`, `artist_id`, `name`, `rating`, `release_date`, `img`, `import_date`) VALUES
	...
	(3, 1, 'Piece of Mind', 8, '1983-05-16', 'https://m.media-amazon.com/images/I/81bJkvVeOoL._UF1000,1000_QL80_DpWeblab_.jpg', '2024-04-23 14:00:06');
...
-- Dumping data for table skivor_ab.songs: ~22 rows (approximately)
DELETE FROM `songs`;
INSERT INTO `songs` (`id`, `album_id`, `artist_id`, `name`, `duration`, `release_year`) VALUES
	...
	(21, 3, 1, 'Where Eagles Dare', '00:06:08', '1968');
